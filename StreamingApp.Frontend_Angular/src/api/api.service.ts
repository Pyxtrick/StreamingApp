...
export class StreamerBotContollerClient {
    ...
    startStream(youtubeId: string | undefined): Observable<void> {
        ...
        if (youtubeId === null)
            throw new Error("The parameter 'youtubeId' cannot be null.");
    ...
    command(userId: string | undefined, userName: string | undefined, message: string | undefined, broadcastUserName: string | undefined, isModerator: boolean | undefined): Observable<void> {
        ...
        if (broadcastUserName === null)
            throw new Error("The parameter 'broadcastUserName' cannot be null.");
        else if (broadcastUserName !== undefined)
            url_ += "broadcastUserName=" + encodeURIComponent("" + broadcastUserName) + "&";
        if (isModerator === null)
            throw new Error("The parameter 'isModerator' cannot be null.");
    ...
    raidAllert(userName: string | undefined, userId: string | undefined, raidSize: number | undefined): Observable<void> {
        ...
        if (userId === null)
            ...
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        if (raidSize === null)
            throw new Error("The parameter 'raidSize' cannot be null.");
...
export class TTSData implements ITTSData {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"] !== undefined ? _data["id"] : <any>null;
            this.message = _data["message"] !== undefined ? _data["message"] : <any>null;
            this.originalMessage = _data["originalMessage"] !== undefined ? _data["originalMessage"] : <any>null;
            this.messageLengthSeconds = _data["messageLengthSeconds"] !== undefined ? _data["messageLengthSeconds"] : <any>null;
            this.isActive = _data["isActive"] !== undefined ? _data["isActive"] : <any>null;
            this.posted = _data["posted"] ? new Date(_data["posted"].toString()) : <any>null;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id !== undefined ? this.id : <any>null;
        data["message"] = this.message !== undefined ? this.message : <any>null;
        data["originalMessage"] = this.originalMessage !== undefined ? this.originalMessage : <any>null;
        data["messageLengthSeconds"] = this.messageLengthSeconds !== undefined ? this.messageLengthSeconds : <any>null;
        data["isActive"] = this.isActive !== undefined ? this.isActive : <any>null;
        data["posted"] = this.posted ? this.posted.toISOString() : <any>null;
        return data;
    }
}
