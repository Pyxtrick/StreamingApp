...
export class CommandClient {
  ...
  protected processDeleteCommands(
    response: HttpResponseBase
  ): Observable<CommandRespose> {
    const status = response.status;
    const responseBlob =
...
export class SpecialWordClient {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<SpecialWordRespose>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetAllspecialWords(
    response: HttpResponseBase
  ): Observable<SpecialWordRespose> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  updatespecialWords(
    commandAndResponses: SpecialWordDto[]
  ): Observable<SpecialWordRespose> {
    let url_ = this.baseUrl + '/api/SpecialWord';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processUpdatespecialWords(
    response: HttpResponseBase
  ): Observable<SpecialWordRespose> {
    const status = response.status;
    const responseBlob =
  ...
  protected processDeletespecialWords(
    response: HttpResponseBase
  ): Observable<SpecialWordRespose> {
    const status = response.status;
    const responseBlob =
...
export class SpecialWordRespose implements ISpecialWordRespose {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.sw)) {
      data['sw'] = [];
      for (let item of this.sw) data['sw'].push(item.toJSON());
    }
    data['isSucsess'] =
      this.isSucsess !== undefined ? this.isSucsess : <any>null;
    return data;
...
export class SpecialWordDto implements ISpecialWordDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.timesUsed =
        _data['timesUsed'] !== undefined ? _data['timesUsed'] : <any>null;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data['timesUsed'] =
      this.timesUsed !== undefined ? this.timesUsed : <any>null;
    return data;
  }
}
